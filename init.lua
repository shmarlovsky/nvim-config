...
-- disable default vim.lsp keymaps
-- vim.lsp.defaults.set_keymaps = false
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      -- Without registering - no desciprion for key group
      spec = {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- configure as default vim.lsp keymaps
